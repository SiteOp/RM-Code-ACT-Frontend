...
/**
 * ticklist Table class
 *
 * @since  1.6
 */
class ActTableticklist extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'ActTableticklist', array('typeAlias' => 'com_act.ticklist'));
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_act.ticklist.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_act/access.xml',
				"/access/section[@name='ticklist']/"
			);
			$default_actions = JAccess::getAssetRules('com_act.ticklist.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_act.ticklist.' . (int) $this->$k;
	}
