 ...
 * @since  1.6
 */
class ActTablecomment extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'ActTablecomment', array('typeAlias' => 'com_act.comment'));
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_act.comment.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_act/access.xml',
				"/access/section[@name='comment']/"
			);
			$default_actions = JAccess::getAssetRules('com_act.comment.' . $array['id'])->getData();
			$array_jaccess   = array();
