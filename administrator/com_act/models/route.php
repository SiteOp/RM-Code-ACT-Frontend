 ...
 * @since  1.6
 */
class ActModelRoute extends JModelAdmin
{
	/**
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_act.route';
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_act.edit.route.data', array());
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__act_route');
				$max             = $db->loadResult();
