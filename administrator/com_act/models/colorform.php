 ...
 * @since  1.6
 */
class ActModelColorForm extends JModelForm
{
    private $item = null;
    ...
    protected function populateState()
    {
        ...
        {
                $id = Factory::getApplication()->getUserState('com_act.edit.color.id');
        }
        else
        {
                $id = Factory::getApplication()->input->get('id');
                Factory::getApplication()->setUserState('com_act.edit.color.id', $id);
        }
     ...
     */
    public function getTable($type = 'Color', $prefix = 'ActTable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_act.color', 'colorform', array(
                        'control'   => 'jform',
                        'load_data' => $loadData
                )
        );
    ...
    {
        $data = Factory::getApplication()->getUserState('com_act.edit.color.data', array());
