 ...
 * @since  1.6
 */
class ActViewComments extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ACT_TITLE_COMMENTS'), 'comments.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_act&view=comments');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`route`' => JText::_('COM_ACT_COMMENTS_ROUTE'),
			'a.`review_yn`' => JText::_('COM_ACT_COMMENTS_REVIEW_YN'),
			'a.`stars`' => JText::_('COM_ACT_COMMENTS_STARS'),
			'a.`myroutegrade`' => JText::_('COM_ACT_COMMENTS_MYROUTEGRADE'),
			'a.`comment`' => JText::_('COM_ACT_COMMENTS_COMMENT'),
			'a.`ticklist_yn`' => JText::_('COM_ACT_COMMENTS_TICKLIST_YN'),
			'a.`ascent`' => JText::_('COM_ACT_COMMENTS_ASCENT'),
			'a.`tries`' => JText::_('COM_ACT_COMMENTS_TRIES'),
			'a.`climbdate`' => JText::_('COM_ACT_COMMENTS_CLIMBDATE'),
			'a.`tick_comment`' => JText::_('COM_ACT_COMMENTS_TICK_COMMENT'),
			'a.`ordering`' => JText::_('JGRID_HEADING_ORDERING'),
			'a.`created_by`' => JText::_('COM_ACT_COMMENTS_CREATED_BY'),
			'a.`created`' => JText::_('COM_ACT_COMMENTS_CREATED'),
			'a.`modified`' => JText::_('COM_ACT_COMMENTS_MODIFIED'),
		);
	}
