...
<?php else : ?>
    ...
    <?php if (!empty($this->item->id)): ?>
        <div class="page-header">
            <h1><?php echo JText::sprintf('COM_ACT_FORM_SETTER_EDIT_ITEM_TITLE', $this->item->id); ?></h1>
        </div>
	<?php else: ?>
        <div class="page-header">
            <h1 itemprop="headline"><?php echo JText::_('COM_ACT_FORM_SETTER_APPLY_ITEM_TITLE'); ?></h1>
        </div>
    <?php endif; ?>
    ...
    <div id="form-edit" class="setter-edit front-end-edit">
            <form id="form-setter"
                  action="<?php echo JRoute::_('index.php?option=com_act&task=setter.save'); ?>"
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <a class="btn btn-warning"
                           href="<?php echo JRoute::_('index.php?option=com_act&task=setterform.cancel'); ?>"
