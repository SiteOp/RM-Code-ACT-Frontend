 ...
 * @since  1.6
 */
class ActViewComment extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ACT_TITLE_COMMENT'), 'comment.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_act.comment', $this->item->id);
		}
