...
<?php endif; ?>
<div class="ticklist-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-ticklist"
			  action="<?php echo JRoute::_('index.php?option=com_act&task=ticklist.save'); ?>"
			  method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
			
	<?php echo $this->form->renderField('id'); ?>

	<?php echo $this->form->renderField('route'); ?>
	<input type="readonly" name="jform[route]" id="jform_route" value="<?php echo $this->item->id; ?>" />

	<?php echo $this->item->id; ?>
	<?php echo $this->form->renderField('comment'); ?>
	 <!-- <input type="textarea" name="jform[comment]" id="jform_comment" value=""  /> -->
	...
	<?php echo $this->form->renderField('created'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_act&task=ticklistform.cancel'); ?>"
