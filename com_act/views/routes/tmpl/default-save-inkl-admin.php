        ...
        <table class="table table-striped table-sm" id="routeList">
            ...
            <tr>
                ...
                <th class="r_setterdate d-none d-md-table-cell"><?php // Setterdate ?>
                    <?php echo HTMLHelper::_('grid.sort', 'COM_ACT_TABLE_HEADER_ROUTES_SETTERDATE', 'setterdate', $listDirn, $listOrder); ?>
                </th>
            ...
            <?php foreach ($this->items as $i => $item) : ?>
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td class="text-center"><?php // VR_Grade Wenn Null dann - Wichtig für Speedroute ?>
                     <?php echo (empty($item->settergrade)) ? '-' : ActHelpersAct::uiaa($item->settergrade); ?><?php // Short if else ?>
                    </td> 
